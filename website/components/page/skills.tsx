...
export default function Skills() {
    ...
    return (
        <div className="">
            <div className="border-x-2 border-none border-b-2 font-bold text-xl pt-10 pl-3   uppercase tracking-[0.01em]"> Stack I use </div>
            <div className=" border-x-2 border-none border-b-2">
