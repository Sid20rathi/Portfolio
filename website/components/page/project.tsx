    ...
    return (
        <div className="">
            ...
            <div className="border-x-2 border-dashed border-b-2  w-full flex items-center justify-center pt-2 pb-2 ">
                ...
                <div className=" border-2 p-1 rounded-4xl w-24  flex items-center justify-center dark:border-white animate-pulse hover:shadow-xl transition-all duration-500">
